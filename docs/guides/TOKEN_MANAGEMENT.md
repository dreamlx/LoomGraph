...
| 字段 | 填写内容 | 说明 |
|------|---------|------|
| **Token name** | `loomgraph-客户名-YYYYMMDD` | 如 `loomgraph-customer-20260224` |
...
customer:
  name: "智采云链"
  contact: "张三 <zhangsan@customer.com>"

  # GitHub Token 信息（敏感，不提交 Git）
  github_token_name: "loomgraph-customer-20260224"
...
customer|github_pat_xxxxx|2026-02-24|2026-05-25
customer|github_pat_yyyyy|2026-02-24|2026-05-25
EOF
...
cat > install_command_customer.txt << EOF
# 智采云链 - LoomGraph 安装命令
# 有效期至: 2026-05-25
...
⚠️  即将过期（30 天内）:
  - customer (loomgraph-customer-20260224): 25 天后过期
  - customer (loomgraph-customer-20260224): 25 天后过期
...
您的 LoomGraph Token (loomgraph-customer-20260224) 已按计划撤销。
