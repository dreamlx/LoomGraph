...
| 客户 | LightRAG 端口 | URL |
|------|--------------|-----|
| 拼便宜 | 3010 | http://117.131.45.179:3010 |
| 智采云链 | 3020 | http://117.131.45.179:3020 |
...
# → dist/loomgraph-zcyl-v0.1.0.tar.gz
```

包内容：
```
loomgraph-zcyl-v0.1.0/
...
│                        我们（开发者）                            │
│  python scripts/package.py --customer zcyl                      │
│  → 生成 loomgraph-zcyl-v0.1.0.tar.gz → 发送给客户                │
└─────────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────────┐
...
```yaml
lightrag:
  api_url: "http://117.131.45.179:3020"
...
README 说明设置环境变量：
```bash
export LOOMGRAPH_LIGHTRAG__API_URL="http://117.131.45.179:3020"
```
...
预期输出应显示连接到 http://117.131.45.179:30XX
...
dist/                    # 打包输出 (gitignore)
├── loomgraph-pinbianyi-v0.1.0.tar.gz
└── loomgraph-zcyl-v0.1.0.tar.gz
```
