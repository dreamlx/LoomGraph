...
```
~/Projects/
├── codeindex/              # /Users/dreamlinx/Projects/codeindex
├── LightRAG/               # /Users/dreamlinx/Projects/LightRAG (fork)
└── LoomGraph/              # /Users/dreamlinx/Dropbox/.../LoomGraph
```
...
[tool.uv.sources]
# 开发时使用本地路径
matrix-codeindex = { path = "/Users/dreamlinx/Projects/codeindex" }
lightrag-hku = { path = "/Users/dreamlinx/Projects/LightRAG" }
```
