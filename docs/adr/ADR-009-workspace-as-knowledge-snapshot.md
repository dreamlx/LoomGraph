...
| workspace 名 | 含义 |
|--------------|------|
| `zcyl-backend` | zcyl-backend 项目，当前工作状态 |
| `zcyl-backend:main` | zcyl-backend 的 main 分支快照 |
| `zcyl-backend:feature-auth` | feature 分支快照 |
| `zcyl-backend:v2.0` | v2.0 版本快照 |
| `zcyl-all` | gateway + backend + common 联合索引 |
