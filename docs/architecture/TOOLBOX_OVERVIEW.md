...
│  │  - 技术债分析                                                     │  │
│  │                                                                   │  │
│  │  仓库: /Users/dreamlinx/Projects/codeindex                        │  │
│  │  状态: v0.5.0 (本地开发)                                          │  │
│  └───────────────────────────────────────────────────────────────────┘  │
│                                    │                                    │
│                                    │ import                             │
...
│  │  - MCP 服务                                                       │  │
│  │                                                                   │  │
│  │  仓库: /Users/dreamlinx/Projects/LoomGraph                        │  │
│  │  状态: v0.0.1 (规划中)                                            │  │
│  └───────────────────────────────────────────────────────────────────┘  │
│                                    │                                    │
│                                    │ import (fork)                      │
...
dev-dependencies = [
    # 本地 codeindex
    "codeindex @ file:///Users/dreamlinx/Projects/codeindex",
    # 本地 LightRAG fork
    "lightrag-hku @ file:///Users/dreamlinx/Projects/LightRAG",
]
...
4. **本地开发目录**：
   - 当前 codeindex: `/Users/dreamlinx/Projects/codeindex`
   - 当前 LoomGraph: `/Users/dreamlinx/Dropbox/Projects/NetBeansProjects/LoomGraph`
   - LightRAG fork 放哪里？建议: `/Users/dreamlinx/Projects/LightRAG`
