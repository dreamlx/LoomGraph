...
Example:
    LIGHTRAG_API_URL=http://117.131.45.179:3001 pytest tests/integration/test_h200_e2e.py -v
"""
...
LIGHTRAG_API_URL = os.getenv("LIGHTRAG_API_URL", "http://117.131.45.179:3001")
