...
>
> ⚠️ **安全**：历史提交（ba9feea 等）曾含真实 GitHub PAT 明文（zcyl/pinbianyi/demo 各 2 个）。
...
|------|------|------------------|-------------|
| 智采云链（zcyl） | Java | 117.131.45.179:3020 | 企业微信密聊 |
| 拼便宜（pinbianyi） | PHP | 117.131.45.179:3010 | 企业微信密聊 |
| Demo 测试用户（demo） | Python | 117.131.45.179:3030 | 内部测试 |

> 117.131.45.179（H200）已于 2026-07 退役。上述客户如仍在用，需迁移到本地 SQLite 架构
